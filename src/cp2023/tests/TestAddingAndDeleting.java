...
public final class TestAddingAndDeleting {
...
//                executeTransfer(system, 101, 0, 3, 20);
//                sleep(30);
//                executeTransfer(system, 105, 0, 0, 10);
...
//        }));
        ...
        transferer.add(new Thread(new Runnable() {
            ...
            public void run() {
                System.out.println("Transferer " + Thread.currentThread().getId() + " has started.");
                executeTransfer(system, 111, 0, 1, 10);
                System.out.println("Transferer " + Thread.currentThread().getId() + " has finished.");
            }
        }));
//        transferer.add(new Thread(new Runnable() {
...
//        }));
        transferer.add(new Thread(new Runnable() {
            ...
            public void run() {
                System.out.println("Transferer " + Thread.currentThread().getId() + " has started.");
                executeTransfer(system, 101, 1, 0, 20);
                System.out.println("Transferer " + Thread.currentThread().getId() + " has finished.");
            }
        }));
        transferer.add(new Thread(new Runnable() {
            ...
            public void run() {
                System.out.println("Transferer " + Thread.currentThread().getId() + " has started.");
                executeTransfer(system, 103, 1, 0, 20);
                System.out.println("Transferer " + Thread.currentThread().getId() + " has finished.");
            }
        }));
        return transferer;
